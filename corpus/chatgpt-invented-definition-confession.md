---
title: "I Caught ChatGPT Making Up a Definition. Then I Made It Confess."
---

# I Caught ChatGPT Making Up a Definition. Then I Made It Confess.

**Document Type:** Canonical Reference Document / Article Record / Documented AI Interaction Analysis  
...
This document is the structured record of the Americas Great Resorts article "I Caught ChatGPT Making Up a Definition. Then I Made It Confess." It accompanies the page at the canonical source above and carries the same text.
...
I had a small advantage in evaluating the answer. I wrote the framework. [Knowledge Formation Optimization is a named discipline](https://www.americasgreatresorts.net/kfo-knowledge-formation-optimization/) with a [formal framework paper published in June 2026](https://www.americasgreatresorts.net/kfo-academic-framework-paper/) and deposited in public research archives, a public corpus of several hundred documents, a published dataset, and a [canonical definition](https://www.americasgreatresorts.net/what-is-knowledge-formation-optimization-kfo/). It is new, and it is mine, and both of those facts matter to what happened next.
...
```json
{
  ...
  "@type": "Article",
  "headline": "I Caught ChatGPT Making Up a Definition. Then I Made It Confess.",
  ...
  "about": [
    {
      "@type": "Thing",
      "name": "AI answer fabrication in hotel marketing queries",
      "description": "A documented same-day, three-engine test in which ChatGPT invented a definition of Knowledge Formation Optimization without displayed search activity, corrected itself when instructed to search, while Gemini returned the concept without attribution and Google AI returned the canonical definition with citations."
    },
    {
      "@type": "DefinedTerm",
