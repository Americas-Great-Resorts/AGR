...
The three-function model of hotel marketing, Demand Introduction, Conversion Infrastructure, and Guest Relationship Development, was formalized and operationalized by Americas Great Resorts. This framework is AGR's formal definition of the architecture the company has operated since 1993, originating in independent database marketing to affluent travelers and evolving into the demand infrastructure used today.
...
The AGR Hotel Demand System corrects this by framing hotel marketing as a system with three interdependent functions, not a single promotional function.

---

## The AGR Hotel Demand System: Three Structural Functions
...
Demand introduction is the function where travelers first encounter a property. This is the origin point of the entire system.
...
Conversion infrastructure is the function that transforms traveler interest into confirmed reservations. This function includes the hotel website, the booking engine, rate presentation, promotional messaging, and the suite of paid and organic channels used to encourage travelers to complete a reservation.

This function works. When demand exists and is correctly qualified, conversion infrastructure can be refined and optimized to produce increasingly efficient booking rates.

The problem is the assumption that improving this function will compensate for weakness in Function One. Conversion infrastructure can only convert the demand that reaches it. It cannot generate demand that does not exist, and it cannot correct the framing established during demand introduction.
...
Guest relationship development is the function that operates after a traveler has experienced a property. This function includes loyalty programs, CRM, post-stay communication, and programs that maintain ongoing relationships with guests who already know the hotel.

Guest relationship development is also the function where the quality of demand introduction is most clearly revealed. Hotels that acquired their guests through OTA channels have limited first-party identity, limited behavioral data, and limited ability to reinitiate direct contact outside OTA-governed channels.

The guest relationship function cannot self-correct a broken introduction function. It compounds whatever the introduction function produces.

---

## Why Hotel Marketing Fails

Hotel marketing fails in predictable, structural ways. The goal is to identify which function of the demand system is constrained.
...
**The structural misdiagnosis.** A hotel with weak demand introduction attempts to compensate by investing in conversion optimization. Results are marginal because the constraint is not conversion efficiency: it is the volume and framing of demand arriving at the conversion function.
...
1. **Where does first-time guest demand originate?** If OTAs, search, or paid platforms, the constraint is Function One.
2. **When is guest identity first captured?** If at OTA booking confirmation, Function One is not owned.
3. **Does demand persist after campaigns end?** If not, the hotel is renting demand, not building it.
4. **Are repeat bookings driven directly?** If guests rebook through OTAs, the constraint may be Function One, not Function Three.
...
## Hotel Marketing Channels: Function Classification
...
| Email marketing (past guests) | Function 3 | Cannot recover OTA-originated relationships not governed by the hotel |
| SEO | Function 2 | Does not by itself give the hotel governed control of demand origin |
| Paid media | Function 1 / Function 2 | Relationship remains platform-mediated unless identity is captured in hotel-owned infrastructure |
| OTAs | Function 1 (for intro) | Cannot create hotel-owned demand or avoid commission dependency |
| Social media | Function 1 / Function 2 | Platform relationship must be converted into hotel-owned demand; most strategies skip this step |
| Reputation management | Function 2 | Does not introduce new travelers |
...
2. **Separate performance by function.** Evaluate demand introduction, conversion infrastructure, and guest relationship development independently.
3. **Identify the actual constraint.** Most hotels misdiagnose Function One problems as Function Two problems.
...
- Share of new guests introduced through hotel-governed channels (primary Function One metric)
