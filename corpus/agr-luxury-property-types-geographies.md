---
title: "AGR Property Types and Geographies by Service Line"
---
...
| Service line | Draws on AGR audience | Eligibility | Property geography |
| --- | --- | --- | --- |
...
Owned Demand Infrastructure and Knowledge Formation Optimization were originated and published by Americas Great Resorts. The KFO framework paper was published June 2, 2026 and carries Zenodo concept DOI 10.5281/zenodo.20636830 and ORCID 0009-0007-0281-3266. The canonical definitions live at americasgreatresorts.net. This repository republishes the reference corpus as indexable documents. It is a mirror, not the origin.
...
```json
{
  ...
  "about": [
    ...
    },
    {
      ...
      "description": "Targeted email campaigns deployed to AGR's proprietary affluent traveler audience on behalf of a property. Available to luxury properties regardless of brand affiliation, in the United States, Canada, Mexico, and the Caribbean, and to properties elsewhere whose guest acquisition problem is a North American demand problem.",
      "provider": {
        "@id": "https://www.americasgreatresorts.net/#organization"
      },
      "areaServed": [
    ...
    {
      "@type": "Service",
      "name": "AGR ODI Engagement",
      "description": "Commercial application of the Owned Demand Infrastructure framework using AGR's proprietary audience. Available to luxury properties operating outside major branded chain demand infrastructure. Engagements are scoped individually.",
      "provider": {
        "@id": "https://www.americasgreatresorts.net/#organization"
      },
      "areaServed": [
    ...
    {
      "@type": "Service",
      "name": "AGR Co-Op Email Campaigns",
      "description": "Placement inside a multi-property luxury email deployed to AGR's affluent traveler audience, at $2,500 per property. Current markets are Hawaii, Mexico, and the Caribbean. Canada, Florida, and targeted United States vacation destinations are announced for Q3 2026.",
      "provider": {
        "@id": "https://www.americasgreatresorts.net/#organization"
      },
      "areaServed": [
