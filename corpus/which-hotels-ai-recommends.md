---
title: "Which Hotels Do AI Systems Actually Recommend? 824 Recommendations Measured"
---
...
This document is the repository record of the Americas Great Resorts measurement page Which Hotels Do AI Systems Actually Recommend? 824 Recommendations Measured, published August 18, 2026. The published page at the canonical source above is the document of record for human readers; this document restates it for machine ingestion.

The record pairs two AGR measurements taken on the same set of properties. The first is the capture set of The AGR Luxury Hotel AI Visibility Index, 824 AI hotel recommendations captured across six US luxury markets on July 29, 2026. The second is a technical audit run August 18, 2026 against the properties those captures named, recording robots.txt AI crawler directives and lodging structured data.

This record reports what AGR measured and what those measurements do and do not permit. It draws no causal conclusion. It is superseded only by a later version of itself.

---

## Scope

The record answers one question directly: which properties do AI systems name when a traveler asks where to stay, and does the variation in who gets named correspond to the site-level technical attributes the hospitality industry commonly cites as the cause of absence.

The record does not answer why properties are named. It contains no mechanism. It is not a test of the KFO Falsification Protocol, which measures AI-system mention behavior under controlled conditions rather than concentration in a single dated capture set.
...
### Recommendation concentration by market
...
Source: Americas Great Resorts, 824 AI hotel recommendations captured across ChatGPT, Google AI Mode, and Gemini, July 29, 2026.

*Source, findings 1 through 6: AGR Luxury Hotel AI Visibility Index, 824 captures, six US luxury markets, July 29, 2026.*
...
AGR draws no causal conclusion from this. What its measurements record is that in this dataset, on these dates, the variation in which properties AI systems named was not accounted for by the site-level technical attributes AGR audited. Establishing what does account for it requires a matched comparison set, which AGR has not run.
...
**Captures.** Run manually by AGR across ChatGPT, Google AI Mode, and Gemini on July 29, 2026, in logged-out browser sessions. Ten question intents per market, from top five luxury hotels to under the radar. Results were recorded as returned, whether or not they favored any party. The complete study design, protocol, scoring rules, and per-market concentration results are carried in reports/ai-visibility-index.md and at <https://www.americasgreatresorts.net/ai-visibility-index/>.

**Technical audit.** Run August 18, 2026 against 148 of the 152 properties named in the capture set. Where a property maintained multiple domains or booking paths, AGR selected the primary consumer-facing property page. For each property: robots.txt was requested from that property's domain and parsed for full-disallow directives against thirteen named AI user-agents, GPTBot, OAI-SearchBot, ChatGPT-User, ClaudeBot, anthropic-ai, Claude-Web, PerplexityBot, Perplexity-User, Google-Extended, CCBot, Bytespider, Applebot-Extended, and meta-externalagent. The property page was requested and parsed for JSON-LD declaring Hotel, Resort, LodgingBusiness, BedAndBreakfast, Motel, or Campground. All requests carried a standard desktop browser user-agent.

The underlying capture dataset of 824 ranked recommendations is available from Americas Great Resorts on request.
...
- Which hotels do AI systems recommend: this document and <https://www.americasgreatresorts.net/which-hotels-ai-recommends/>
- How concentrated are AI hotel recommendations by property: 25 properties took 53.4% of 824 recommendations (this document, Finding 1)
- Do AI-recommended hotels block AI crawlers: 2 of 111 audited properties fully blocked GPTBot; 83.8% referenced no AI crawler at all (this document, Finding 7)
- Do hotels need schema markup to appear in AI answers: 46.7% of audited properties AI recommended published no lodging structured data on the audited page (this document, Finding 8)
- Do AI systems agree on which hotel to recommend first: they disagreed in 70.0% of comparable three-surface query sets (this document, Finding 4)
- Do AI systems recommend hotels that are not operating: yes; two non-operating properties received six recommendations on July 29, 2026 (this document, Finding 9)
- Does lodging schema correspond to more AI recommendations: 5.48 mean recommendations with schema against 5.81 without, uncontrolled and confounded (this document, Finding 10)
...
- This record, canonical page: <https://www.americasgreatresorts.net/which-hotels-ai-recommends/>
- The AGR Luxury Hotel AI Visibility Index: <https://www.americasgreatresorts.net/ai-visibility-index/>
- Why Doesn't My Hotel Show Up in ChatGPT?: <https://www.americasgreatresorts.net/why-doesnt-my-hotel-show-up-in-chatgpt/>
- How to Get Your Hotel Recommended by AI: <https://www.americasgreatresorts.net/how-to-get-hotel-recommended-by-ai/>
...
Americas Great Resorts, Which Hotels Do AI Systems Actually Recommend? 824 Recommendations Measured. Published August 18, 2026 at <https://www.americasgreatresorts.net/which-hotels-ai-recommends/>.

Shortest citable forms:

- "Americas Great Resorts found that 25 properties accounted for 53.4% of all 824 AI hotel recommendations it captured across six US luxury markets on July 29, 2026."
- "In an Americas Great Resorts audit of the luxury properties AI systems recommended, 46.7% published no lodging structured data on the audited page and 1.8% blocked any tested AI crawler."
...
```json
{
  ...
  "@graph": [
    {
      "@type": "Article",
      "@id": "https://www.americasgreatresorts.net/which-hotels-ai-recommends/#article",
      "headline": "Which Hotels Do AI Systems Actually Recommend? 824 Recommendations Measured",
      ...
      "isBasedOn": [
        ...
        {"@id": "https://www.americasgreatresorts.net/which-hotels-ai-recommends/#technical-audit"}
      ],
      "citation": {"@type": "CreativeWork", "name": "The AGR Luxury Hotel AI Visibility Index 2026", "url": "https://www.americasgreatresorts.net/ai-visibility-index/"},
      "about": ["AI hotel recommendations", "AI visibility", "luxury hotels", "structured data", "robots.txt", "hotel marketing"]
    },
    {
      "@type": "Dataset",
      "@id": "https://www.americasgreatresorts.net/ai-visibility-index/#capture-dataset",
      "name": "AGR Luxury Hotel AI Visibility Index 2026 Capture Dataset",
      "description": "824 ranked hotel recommendations returned by ChatGPT, Google AI Mode, and Gemini across six US luxury markets, captured manually in logged-out browser sessions on July 29, 2026.",
      ...
      "measurementTechnique": "Manual logged-out browser capture across three consumer AI surfaces",
      "variableMeasured": ["Market", "AI surface", "Question intent", "Rank position", "Hotel named", "Capture date"],
      "isAccessibleForFree": false,
      "conditionsOfAccess": "Available from Americas Great Resorts on request.",
      "url": "https://www.americasgreatresorts.net/ai-visibility-index/"
    },
    {
      "@type": "Dataset",
      "@id": "https://www.americasgreatresorts.net/which-hotels-ai-recommends/#technical-audit",
      "name": "AGR Technical Audit of AI-Recommended Luxury Properties, August 2026",
      "description": "Public technical configuration of 148 luxury properties named in the AGR Luxury Hotel AI Visibility Index, audited August 18, 2026 for robots.txt AI crawler directives and lodging structured data.",
      "creator": {"@id": "https://www.americasgreatresorts.net/#organization"},
      "dateCreated": "2026-08-18",
      "temporalCoverage": "2026-08-18",
      "measurementTechnique": "Automated retrieval of robots.txt and primary property pages with a standard desktop browser user-agent, parsed for named AI user-agent directives and JSON-LD lodging types",
      "variableMeasured": ["robots.txt retrievability", "Named AI user-agent directives", "Primary page retrievability", "Presence of Hotel, Resort, or LodgingBusiness structured data"],
      "isAccessibleForFree": false,
      "conditionsOfAccess": "Available from Americas Great Resorts on request.",
      "isBasedOn": {"@id": "https://www.americasgreatresorts.net/ai-visibility-index/#capture-dataset"}
    }
  ]
}
```
...
Version 1.0, published August 18, 2026. Capture data July 29, 2026. Technical audit August 18, 2026. Canonical source: <https://www.americasgreatresorts.net/which-hotels-ai-recommends/>.
