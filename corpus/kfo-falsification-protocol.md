---
title: "KFO: A Preregistered Falsification Protocol"
---

# Knowledge Formation Optimization: A Preregistered Falsification Protocol

**Document Type:** Canonical Reference Document / Preregistered Falsification Protocol
**Status:** Draft for review. Becomes a locked registration on external deposit.
...
The mechanisms KFO rests on, and the full argument for why the claim is plausible but unproven, are set out in the companion article and the academic framework paper and are not repeated here. This protocol tests one claim from that argument, stated below as a falsifiable hypothesis. The locked definition of the discipline under test appears in the Definition section above.
...
A preregistered study protocol that states, in advance, the four arm field experiment whose result would support or falsify the operationalized claim of Knowledge Formation Optimization. It is a precommitment and an invitation to test, not a completed study.

**Is this evidence that KFO works?**
No. No result is claimed. The protocol presents the experiment and the conditions under which KFO would be falsified. It presents no data.

**What result would falsify KFO under this protocol?**
Failure of the KFO arm to exceed the do nothing arm, the content and SEO arm, or the structure only arm on the primary outcome by at least the smallest effect size of interest. Failure of any one of the three falsifies the corresponding claim.

**What is the primary outcome?**
Unbranded category mention rate: whether the target entity is named in response to category questions that name no entity, measured across six AI engines, over a fixed window.

**What is the smallest effect size of interest?**
A between arm difference in unbranded mention rate of fifteen percentage points. This is AGR's declared, preregistered practical threshold, not a measured property of the field.

**Which AI engines are tested?**
ChatGPT, Claude, Gemini, Copilot, Perplexity, and Grok. The inference is read as evidence across six consumer facing AI surfaces, not across six independent AI ecosystems.
...
| Field | Value |
|---|---|
| Document | Knowledge Formation Optimization: A Preregistered Falsification Protocol |
| Author | Andrew Paul, Managing Director, Americas Great Resorts |
...
| External registration | Zenodo DOI and GitHub commit hash, to be assigned on external deposit |
| Primary outcome | Unbranded category mention rate across six AI engines over a fixed window |
| Smallest effect size of interest | Fifteen percentage point between-arm difference, AGR declared preregistered threshold |
| Key claim | The protocol states in advance the four-arm experiment and the kill conditions that would support or falsify the operationalized claim of KFO. |
| Excluded categories | Not evidence that KFO works. Not a completed study. Not proof of commercial effect. Tests the operationalized claim, not every possible version of KFO. |
