...
Open item, not addressed in this pass. Knowledge Formation Optimization has no Wikidata item. Until it exists, the different from P1889 statement separating it from Knowledge Federation cannot be made, and the disambiguation recorded on August 21 lives only on AGR-controlled surfaces. A self-published assertion that two terms are distinct carries no weight with a resolver; the same assertion on Wikidata does, and Wikidata is upstream of the Google Knowledge Graph and of the public knowledge bases that mirror into training corpora. Creating the KFO item, typed as a scholarly article or framework, carrying author, DOI, Zenodo ID, publication date, and the P1889 negation, and referenced to the MPRA deposit and the Hospitality Technology coverage rather than to americasgreatresorts.net, is the highest-value remaining item on this track.
