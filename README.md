...
No files added or removed. GitHub file count unchanged at 111 markdown files. The External Publication Record GitHub row is unchanged at 111 and required no edit. Software Heritage, Zenodo, Hugging Face, llms.txt, and the AGR Bible carry the pre-July 26 titles and content for these five records and are scheduled for the next surface pass; the Software Heritage SWHID recorded in this document predates these commits and is not re-archived here.
