...
Graph closure. The paper item carries main subject P921 pointing at the framework item. The framework item carries described by source P1343 pointing at the paper item. Andrew Paul Q140329260 and Americas Great Resorts Q138413230 each carry notable work P800 pointing at the framework item. The four items now hold 53 statements between them with zero unreferenced statements and no open constraint warnings.
